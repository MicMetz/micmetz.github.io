...
<IntroParagraph >
		...
		Timelines are one of Greensock's power features. It turns you into an animation timelord. You could build out an animation made up of hundred of Tweens, and still have complete control and
		flexibility over the sequence, speed, and pacing.
