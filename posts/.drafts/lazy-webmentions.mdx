...
<AssumedAudience >
		People who know enough modern web development and JavaScript to have set up their own website in something like Next.js, Eleventy, Hugo, or Jekyll. You're either a web developer or an advanced web
		hobbyist.
</AssumedAudience >
