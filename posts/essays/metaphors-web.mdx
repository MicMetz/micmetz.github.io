...
growthStage: "budding"
toc: true
cover: "/covers/webmetaphors-cover@2x.png"
---

<IntroParagraph >

		In Tim Berners-Lee's [original pitch](https://www.w3.org/History/1989/proposal.html) for The Web, he described it as a “non-linear text system" for notes. It was designed for scientific researchers
		and academics to pass around documents that would otherwise be printed on physical paper. The _point_ of the web was to mimic long, text-based, paper documents, but simply make them easier to move
		around.
