...
updated: "2021-03-10"
type: "note"
cover: "/covers/problemproteins-cover@2x.png"
...
<IntroParagraph >
		...
		In 2013, in a dutch cellular engineering lab just outside of Utrecht, pharmacologist Mark Post [produced a piece of meat](https://www.new-harvest.org/mark_post_cultured_beef) without killing an
		animal. <Footnote idName = {1} >That's the short version of the story. For the meaty details take a look at my illustrated notes on the book [[Meat Planet]]</Footnote > This is terribly impressive.
		But it also splatters a gigantic can of worms across our definition of “meat.” And by extension the entire food pyramid.
