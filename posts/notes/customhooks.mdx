...
<IntroParagraph >
		...
		Last year the [React](https://reactjs.org/docs/hooks-intro.html) team released a feature called "hooks" that lets you do some powerful stuff we couldn't do as easily before... Managing state.
		Accessing DOM elements. Using side effects.
...
<p >
		<a href = "https://twitter.com/jsjoeio/" >Joe Previte</a >
		made a whole egghead
		course on{" "}
