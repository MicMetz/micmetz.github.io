...
<IntroParagraph >
		...
		Nearly every computer programme created in the last 68 years was made by typing linear characters into a text editor. <a href = "https://en.wikipedia.org/wiki/ASCII" > ASCII</a > symbols arranged
		from left
		to right, top to bottom, are the universal medium of code.

</IntroParagraph >

<BasicImage width = "570px"
