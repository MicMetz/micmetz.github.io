...
<IntroParagraph >
		...
		Suspense is [an upcoming React feature](https://reactjs.org/docs/concurrent-mode-suspense.html) that's part of the new "concurrent mode." Since everyone is getting all hyped up about it, I wanted to
		figure out what the excitement was and drew some quick summary notes.
