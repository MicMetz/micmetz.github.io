import { IdeaMetadataContainer, StyledIdeaCard } from "@/styles/StyledCardComponents/IdeaStyled.js";
...
export default function IdeaCard( { slug, date, title, growthStage, id } ) {
		return (
				<Link key = {id} as = {`/${slug}`} href = {`/${slug}`} >
						<a >
								<StyledIdeaCard initial = "initial" whileHover = "hover" >
										<Leaves />
										<div >
												<h3 >{title}</h3 >
