import { ResponseMetadataContainer, StyledResponseCard } from "@/styles/StyledCardComponents/ResponseStyled.js";
...
export default function ResponseCard( { slug, date, title, growthStage, id } ) {
		return (
				<Link key = {id} as = {`/${slug}`} href = {`/${slug}`} >
						<a >
								<StyledResponseCard initial = "initial" whileHover = "hover" >
										<Leaves />
										<div >
												<h3 >{title}</h3 >
