				...
				<Container >
						<AccordionButton panelOpen = {panelOpen}
								...
								<div className = "header" >
										<PlusCircleIcon width = "22" height = "22" stroke = "var(--color-sea-blue)" />
										<span >{header}</span >
								</div >
								{panelOpen ?
										<div className = "more" >
												<span >Show less</span >
												<ChevronUpIcon width = "20" height = "20" stroke = "var(--color-sea-blue)" /></div > :
										<div className = "more" >
												<span >Read more</span >
												<ChevronDownIcon width = "20" height = "20" stroke = "var(--color-sea-blue)" /></div >
								}
						</AccordionButton >
						<AnimatePresence >
